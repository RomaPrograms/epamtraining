...
<div class="container" id="main_body">
    ...
    <form class="form-horizontal" role="form" id="homestead_reg_form" method="post">
        <div class="form-group">
            <label for="sign_up_name"><fmt:message key="homesteadName"/></label>
        ...
        <div class="form-group">
            ...
            <input id="sign_up_description" type="text" name="description"
                   placeholder="${enterDescription}" class="form-control">
        </div>
        <div class="form-group">
