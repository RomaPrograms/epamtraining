...
import by.training.cube.observer.CubeObserver;

/**
 * Cube is class, with all cube points.
 * @author Roman
 * @version 1.0
 */
public class Cube {
    ...
    /**
     * function change coordinates of cube.
     * @param point1 - first point
     * @param point2 - second point
     * @param point3 - third point
     * @param id - id
     */
    public void changeCoordinate(final Point point1, final Point point2,
                                 final Point point3, final String id) {
        this.a = point1;
        this.b = point2;
        this.c = point3;
    ...
    /**
     * function calls when coordinate changes.
     * @param id - id
     */
    public void notifyObserver(final String id) {
        new CubeObserver().handleEvent(new CubeEvent(this), id);
    }
